        ...
        <div class="row mx-0">
          <div class="col-4 px-0">
            <div class="form-group">
              <label>งวดที่</label>
              <input type="text" name="amount" value="<?php echo $settings->amount; ?>" class="form-control"  required <?php if($settings->status_receive){echo 'readonly';}else{echo '';} ?> />
            </div>
          </div>
        </div>
        <div class="row mx-0">
          <div class="col-4 px-0">
            <div class="form-group">
              ...
              <div class='input-group date' id='datepicker1'>
                <input type='text' name="dateP" value="<?php echo $settings->dateP; ?>" id="click-btn1" class="form-control" required <?php if($settings->status_receive){echo 'readonly';}else{echo '';} ?>/>
          ...
          <div class="col-4 px-0">
            <div class="form-group">
              ...
              <div class='input-group date' id='datetimepicker1'>
                <input type='text' name="datetime" value="<?php echo $settings->public_time; ?>" id="click-btn2" class="form-control" required <?php if($settings->status_receive){echo 'readonly';}else{echo '';} ?>/>

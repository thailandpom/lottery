            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
                <ul class="navbar-nav mr-auto">
                    ...
                    if ($this->session->userdata('userType') == 1) {
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('index.php/user/register') ?>"><i class="fas fa-address-card"> </i> กรุณาสมัครสมาชิกเพื่อใช้งานระบบ</a>
                        </li>
                    <?php } ?>
                </ul>
                <ul class="navbar-nav ml-auto nav-flex-icons">
                    ...
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-light">
                            <span class="badge badge-pill badge-light">0.00<i class="fab fa-btc" aria-hidden="true"></i></span>
                        </a>
                    </li>
                    <?php } ?>
                    <li class="nav-item">
                    ...
                    if ($this->session->userdata('userType') != null) {
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-default"
                                ...
                                <a class="dropdown-item"  href="<?php echo base_url('index.php/user/login') ?>"><i class="fas fa-sign-in-alt"></i> ออกจากระบบ</a>

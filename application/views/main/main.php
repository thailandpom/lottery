...
<div class="container">
    <div class="jumbotron text-center hoverable p-4">
        ...
        <div class="row">
            <div class="col-sm-6 mb-3 mb-md-0">
                ...
                <div class="card border-danger" >
                    <h5 class="card-header h5"> <i class="fas fa-crown"></i> หวยรัฐบาล <font color="red"> 1 ธันวาคม 2562</font></h5>
                    <div class="card-body">
            ...
            <div class="col-sm-6">
                <div class="card border-success" >
                    <h5 class="card-header h5">  <i class="fas fa-crown"></i> หวยรัฐบาล<font color="red"> 16 ธันวาคม 2562</font></h5>
        ...
        <br><div class="col-6">
            <center> <h3> <b><p class="text-danger">จ่ายสูงที่สด บาทละ 800</p>
                หวยรัฐบาลไทย</b></h3></center>
